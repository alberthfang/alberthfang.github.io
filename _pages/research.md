...
> _American Politics Research_ (2017)

> [Journal PDF](https://doi.org/10.1177/1532673X16686556) &#9632; [Local PDF with Appendix](../research/self_paper.pdf) &#9632; [Replication Archive](../research/self_replication.7z) &#9632; <a onclick="openClose('self')" style="cursor: pointer;">Abstract <i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
* **Non-Governmental Campaign Communication Providing Ballot Secrecy Assurances Increases Turnout: Results from Two Large Scale Experiments**

> with Alan S. Gerber, Gregory A. Huber, and Andrew Gooch

> Conditionally accepted at _Political Science Research and Methods_ (2017)

> [Local PDF](../research/bsec_paper.pdf) &#9632; [Online Appendix](../research/bsec_appx.pdf) &#9632; [Replication Archive](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/D8WD6K) &#9632; <a onclick="openClose('bsec')" style="cursor: pointer;">Abstract <i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
> [Local PDF](../research/housing_paper.pdf) &#9632; [Online Appendix](../research/housing_appx.pdf) &#9632; <a onclick="openClose('Housing')" style="cursor: pointer;">Abstract <i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
> with Alan S. Gerber and Gregory A. Huber

> [Local PDF](../research/slc_paper.pdf) &#9632; [Online Appendix](../research/slc_appx.pdf) &#9632; <a onclick="openClose('slc')" style="cursor: pointer;">Abstract <i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
* **When Does Increasing Mobilization Effort Increase Turnout? New Theory and Evidence from a Field Experiment on Reminder Calls**

> with Alan S. Gerber, Gregory A. Huber, and Catlan E. Reardon

> [Local PDF](../research/remindercalls_paper.pdf) &#9632; [Online Appendix](../research/remindercalls_appx.pdf) &#9632; <a onclick="openClose('remindercalls')" style="cursor: pointer;">Abstract <i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
> [Local PDF](../research/posneg_paper.pdf) &#9632; [Online Appendix](../research/posneg_appx.pdf) &#9632; <a onclick="openClose('posneg')" style="cursor: pointer;">Abstract <i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
> [Local PDF](../research/msbs_paper.pdf) &#9632; [Online Appendix](../research/msbs_appx.pdf) &#9632; <a onclick="openClose('msbs')" style="cursor: pointer;">Abstract <i class="fa fa-plus-square" aria-hidden="true"></i></a>
...
* **Publication Bias: Before and After ICMJE Registration Requirements**

> with Grant M. Gordon and Macartan Humphreys

> [Local PDF](../research/ps_paper.pdf) &#9632; <a onclick="openClose('ps')" style="cursor: pointer;">Abstract <i class="fa fa-plus-square" aria-hidden="true"></i></a>
