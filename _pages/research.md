...
> <div style="font-size: 11px;">[Local PDF](../research/housing_paper.pdf) &bull; [Online Appendix](../research/housing_appx.pdf) &bull; [Replication Archive](http://dx.doi.org/10.7910/DVN/CF44OW) &bull; <a onclick="openClose('housing')" style="cursor: pointer;">Abstract <i class="far fa-plus-square" aria-hidden="true"></i></a></div>
